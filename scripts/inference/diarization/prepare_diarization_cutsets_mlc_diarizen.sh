...
EXPERIMENT="diarizen_diar_v2_mlc"
source "${SRC_ROOT}"/configs/local_paths.sh

ORIG_CUTSET="${MLC_MANIFEST_DIR}/val/all.jsonl.gz"
NEW_CUTSET="${MANIFEST_DIR_EXP}/mlc_val_all_diarizen.jsonl.gz"
MODEL="BUT-FIT/diarizen-wavlm-large-s80-mlc"

...
class DiCoWGenerationMixin(WhisperForConditionalGeneration):
    ...
    def generate(
        ...
        output = super().generate(
            ...
            task=task,
            language=kwargs["language"] if "language" in kwargs else language,
            ...
            return_segments=True, # this has to be set to true to correctly reconstruct timestamps
    ...
    def _beam_search(
        ...
        while self._has_unfinished_sequences(this_peer_finished, synced_gpus, device=input_ids.device):
            ...
            next_token_scores_processed = logits_processor(input_ids, next_token_scores, **model_kwargs)
            if do_sample:
